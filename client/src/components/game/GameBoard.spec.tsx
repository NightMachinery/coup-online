...
const mockGameState = {
  ...
  deckCount: 6,
  players: [
    { name: 'Alice', influenceCount: 2, deadInfluences: [], ai: false, coins: 2, color: '#111111', isModerator: false },
    { name: 'Bob', influenceCount: 2, deadInfluences: [], ai: false, coins: 2, color: '#222222', isModerator: false },
    { name: 'Cara', influenceCount: 2, deadInfluences: [], ai: false, coins: 2, color: '#333333', isModerator: false },
    { name: 'Dan', influenceCount: 2, deadInfluences: [], ai: false, coins: 2, color: '#444444', isModerator: false },
    { name: 'Eli', influenceCount: 2, deadInfluences: [], ai: false, coins: 2, color: '#555555', isModerator: false },
    { name: 'Fran', influenceCount: 2, deadInfluences: [], ai: false, coins: 2, color: '#666666', isModerator: false },
    { name: 'Gus', influenceCount: 2, deadInfluences: [], ai: false, coins: 2, color: '#777777', isModerator: false },
  ],
  selfPlayer: {
    name: 'Alice',
    influences: [],
