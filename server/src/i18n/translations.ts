...
const translations = {
  ...
  onlyLobbyCreatorCanStartGame: {
    'de-DE': 'Nur der Ersteller der Lobby oder ein Moderator kann das Spiel starten',
    'en-US': 'Only the lobby creator or a moderator can start the game',
    'es-MX': 'Solo el creador de la sala o un moderador puede iniciar el juego',
    'fr-FR': 'Seul le créateur du salon ou un modérateur peut démarrer la partie',
    'hi-IN': 'केवल लॉबी बनाने वाला या कोई मॉडरेटर ही खेल शुरू कर सकता है',
    'it-IT': 'Solo il creatore della lobby o un moderatore può avviare la partita',
    'pt-BR': 'Somente o criador da sala ou um moderador pode iniciar o jogo',
  },
  ...
  onlyLobbyCreatorOrModeratorCanSetGameSettings: {
    'de-DE': 'Nur der Ersteller der Lobby oder ein Moderator kann die Einstellungen ändern',
    'en-US': 'Only the lobby creator or a moderator can change settings',
    'es-MX': 'Solo el creador de la sala o un moderador puede cambiar la configuración',
    'fr-FR': 'Seul le créateur du salon ou un modérateur peut modifier les paramètres',
    'hi-IN': 'केवल लॉबी बनाने वाला या कोई मॉडरेटर ही सेटिंग्स बदल सकता है',
    'it-IT': 'Solo il creatore della lobby o un moderatore può cambiare le impostazioni',
    'pt-BR': 'Somente o criador da sala ou um moderador pode alterar as configurações',
  },
  onlyLobbyCreatorCanSetPlayerController: {
    ...
    'es-MX': 'Solo el creador de la sala puede cambiar jugadores entre bot y humano',
    'fr-FR': 'Seul le créateur du salon peut basculer les joueurs entre bot et humain',
    'hi-IN': 'केवल लॉबी बनाने वाला ही खिलाड़ियों को बॉट और मानव के बीच बदल सकता है',
    'it-IT': 'Solo il creatore della lobby può cambiare i giocatori tra bot e umani',
    'pt-BR': 'Somente o criador da sala pode alternar jogadores entre bot e humano',
  },
  onlyLobbyCreatorOrModeratorCanManageModerators: {
    'de-DE': 'Nur der Ersteller der Lobby oder ein Moderator kann Moderatoren verwalten',
    'en-US': 'Only the lobby creator or a moderator can manage moderators',
    'es-MX': 'Solo el creador de la sala o un moderador puede administrar moderadores',
    'fr-FR': 'Seul le créateur du salon ou un modérateur peut gérer les modérateurs',
    'hi-IN': 'केवल लॉबी बनाने वाला या कोई मॉडरेटर ही मॉडरेटरों को प्रबंधित कर सकता है',
    'it-IT': 'Solo il creatore della lobby o un moderatore può gestire i moderatori',
    'pt-BR': 'Somente o criador da sala ou um moderador pode gerenciar moderadores',
  },
  onlyLobbyCreatorCanDemoteModerators: {
    'de-DE': 'Nur der Ersteller der Lobby kann Moderatoren herabstufen',
    'en-US': 'Only the lobby creator can demote moderators',
    'es-MX': 'Solo el creador de la sala puede degradar moderadores',
    'fr-FR': 'Seul le créateur du salon peut rétrograder les modérateurs',
    'hi-IN': 'केवल लॉबी बनाने वाला ही मॉडरेटरों को पदावनत कर सकता है',
    'it-IT': 'Solo il creatore della lobby può retrocedere i moderatori',
    'pt-BR': 'Somente o criador da sala pode rebaixar moderadores',
  },
  connectedSpectatorRequired: {
    'de-DE': 'Wähle einen verbundenen Zuschauer, um diesen Platz zu übernehmen',
    'en-US': 'Choose a connected spectator to take over this seat',
    'es-MX': 'Elige un espectador conectado para ocupar este lugar',
    'fr-FR': 'Choisissez un spectateur connecté pour prendre cette place',
    'hi-IN': 'इस सीट को लेने के लिए एक जुड़े हुए दर्शक को चुनें',
    'it-IT': 'Scegli uno spettatore connesso per prendere questo posto',
    'pt-BR': 'Escolha um espectador conectado para assumir este assento',
  },
  playerAlreadyBotControlled: {
    'de-DE': 'Dieser Platz wird bereits von einem Bot gesteuert',
    'en-US': 'This seat is already bot-controlled',
    'es-MX': 'Este asiento ya está controlado por un bot',
    'fr-FR': 'Cette place est déjà contrôlée par un bot',
    'hi-IN': 'यह सीट पहले से ही बॉट द्वारा नियंत्रित है',
    'it-IT': 'Questo posto è già controllato da un bot',
    'pt-BR': 'Este assento já é controlado por um bot',
  },
  playerAlreadyHumanControlled: {
    'de-DE': 'Dieser Platz wird bereits von einem Menschen gesteuert',
    'en-US': 'This seat is already human-controlled',
    'es-MX': 'Este asiento ya está controlado por un humano',
    'fr-FR': 'Cette place est déjà contrôlée par un humain',
    'hi-IN': 'यह सीट पहले से ही किसी इंसान द्वारा नियंत्रित है',
    'it-IT': 'Questo posto è già controllato da un umano',
    'pt-BR': 'Este assento já é controlado por um humano',
  },
  playerNotInGame: {
