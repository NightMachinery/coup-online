...
const translations = {
  ...
  onlyLobbyCreatorCanStartGame: {
    'de-DE': 'Nur der Ersteller der Lobby kann das Spiel starten',
    'en-US': 'Only the lobby creator can start the game',
    'es-MX': 'Solo el creador de la sala puede iniciar el juego',
    'fr-FR': 'Seul le créateur du salon peut démarrer la partie',
    'hi-IN': 'केवल लॉबी बनाने वाला ही खेल शुरू कर सकता है',
